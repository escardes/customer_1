...
const News = () => {
  return (
    <div className='pt-16 pb-16'>
        {/** Sectuion heading */}
        <SectionHeading heading='Renovation and Remodel Update' headingBellow='See why you need to choose Group Y.K.N Services LLC for your remodel and renovation'/>
