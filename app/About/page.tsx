...
export default function About() {
  return (
    <div className='container grid grid-cols-1 md:grid-cols-2 w-full h-[120vh] mx-auto bg-[#f1efef]'>
        <div className='relative bg-[#e7e7e7] flex flex-col items-center justify-center shadow-lg'>
           <h2 className='text-2xl font-extralight tracking-tight shadow-lg mb-4'>
